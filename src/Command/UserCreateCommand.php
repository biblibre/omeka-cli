...
class UserCreateCommand extends AbstractCommand
{
    ...
    {
        return sprintf('%s [--role <role>] <username> <email> <password>', $this->getName());
    }
    ...
    protected function configure()
    {
        ...
        $this->addOption('role', 'r', InputOption::VALUE_REQUIRED, 'User role (super, admin, researcher, contributor)', 'contributor');
